...
const currentFuel = fuelBurnRate*time                               //calculates remaining fuel
const currentVelocity = calcNewVel(acceleration, velocity, time)    //calculates new velocity based on acceleration
